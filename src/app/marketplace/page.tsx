...
export default function MarketplacePage() {
  ...
  return <div className="page-frame marketplace-world marketplace-simple">
    <div className="marketplace-simple-heading"><div><p className="kicker">Listed assets</p><h1>Trade live<br/>asset shares.</h1></div><p>Explore assets with active liquidity, transparent Passport records, and prices derived from current pool reserves.</p></div>
