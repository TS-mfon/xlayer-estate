...
export default function MarketplacePage() {
  ...
  return <div className="page-frame">
    <div className="section-heading"><div><p className="kicker">USDC_TEST / fractional RWA</p><h1 className="text-5xl font-semibold tracking-[-.06em] sm:text-7xl">Property<br />markets.</h1></div><p>Trade evidence-backed ERC-1155 property shares through valuation-anchored liquidity pools.</p></div>
    ...
    {!totalLoading && markets.length === 0 && <div className="glass-panel p-8"><p className="kicker">No markets yet</p><h2 className="mt-3 text-2xl font-semibold">Mint an approved property and seed its first 10 USDC of liquidity.</h2><Link href="/tokenize" className="button button-primary mt-6">Create the first market ↗</Link></div>}
