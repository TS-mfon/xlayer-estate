...
export default function TokenizePage() {
  ...
  return <div className="page-frame asset-origin-page">
    ...
    {phase === "confirmed" && <div className="mint-confirmation"><div className="mint-confirmation-orb">✦</div><p className="kicker">Asset #{tokenId} confirmed</p><h2>Your digital property is built.</h2><p>Opening the liquidity desk so you can list it with the required 10 {network.settlementLabel} seed.</p>{txHash && <a href={explorerTx(network.id, txHash)} target="_blank" rel="noreferrer">View transaction ↗</a>}</div>}
  </div>;
}
