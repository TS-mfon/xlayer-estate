...
export function AssetCard({ id, info, chainId, balance, listed, wallet, pricing }: { id: bigint; info: AssetInfo; chainId: number; balance?: bigint; listed?: boolean; wallet?: string; pricing?: MarketPricing }) {
